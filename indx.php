  ...
  <body>
    ...
    <?php
      foreach ($faq as $question) {
        // ciclo for su $faq[$key]
        echo $question["ask"]. "<br>".$question["answer"];
      }
   ?>
   </div>
  </body>
